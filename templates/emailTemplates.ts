...
export const emailTemplates = {
  ...
  shopVerification: (name, verificationCode, verificationLink, shopName, deepLink?: string) => `
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
  ...
  emailVerification: (name: string, otp: string | number) => `
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
  ...
  passwordReset: (name, resetLink, deepLink?: string) => `
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
